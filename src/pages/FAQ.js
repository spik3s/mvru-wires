				...
				<div className="row">
					<div className="col-12 col-md-6  px-5 my-3">
						...
						<p>
							...
							FAQ to produce > 20,000 female An. dirus and An.
							Minimum per week, we are always ready for malaria
							vaccine testing, transmission studies, and large
							scaled sporozoite production for drug discovery
							projects. We have shipped our infected mosquitoes
							domestically and internationally for malaria
							research and vaccine trails. Our staff have provided
							guidance in setting up mosquito facilities
							worldwide.
						</p>
					</div>
