            ...
            <div className="jumbotron mb-0">
                <div className="container text-center">
                    <div className="row justify-content-center">
                        <div className="col-8">
                            <h1 className="display-3">STORY {props.match.params.id}</h1>
            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col-12 col-md-6  px-5 my-3">
                        <h2>Insectary</h2>
                        <p>Our highly standardised insectary harbours Anopheline mosquitoes for malaria research. With the SingleStory to 
